...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelToolBarSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/check-box.png"))); // NOI18N
        ...
        jScrollPaneDescription.setViewportView(jTextAreaDesciption);
        ...
        jPanelTaskLayout.setVerticalGroup(
            ...
            .addGroup(jPanelTaskLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneNotes, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try {
            if (!jTextFieldName.getText().isEmpty()
                ...
                task.setDescription(jTextAreaDesciption.getText());
...
//            Date deadline = null;
                ...
                this.dispose();
                 ...
                 JOptionPane.showMessageDialog(rootPane, "A tarefa não foi salva, "
                         + "pois existem campos obrigatórios "
                         + "a serem preenchidos.");
            }
